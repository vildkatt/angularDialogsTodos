...
.controller('MyFirstController', function($scope, $http, $modal, tasksResponse){
   'use strict';
   ...
   weekFilter = function(task) {
       var selectedDayOfWeek, daysDistanceUp, daysDistanceDown, distance, selected, tDate, taskDateDays, selectedDateDays;
       tDate = new Date(task.date * 1000);
